...
### P.S. Комментарий к ревьюеру

Читал про библиотеку dependency-injector от нашего разработчика.<br>
Решил сделать через неё для практики, вот такая солянка получилась)
